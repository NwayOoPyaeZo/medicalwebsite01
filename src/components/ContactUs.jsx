        ...
        <section className="w-full pt-16 pb-28 lg:pt-20 lg:pb-32">
            ...
            <div className="relative w-full flex justify-center px-4 mt-10">
                <form className="w-full max-w-[853px] flex flex-col md:flex-row gap-4 md:gap-6 lg:gap-10">
                    <label className="flex w-full md:w-[298px] h-[64px] items-center rounded-[12px] border-2 border-[#32BDFF] px-[12px] bg-white">
                        <img src="src/assets/elements/person.svg" alt="person" className="ml-3 h-5 w-5 flex-shrink-0" />
                        <input
                            type="text"
                            placeholder="Enter Your First Name"
                            className="w-full bg-transparent font-semibold text-[16px] text-[#B0B0B0] placeholder:text-[#B0B0B0] outline-none px-3"
                        />
                    </label>
                    <label className="flex w-full md:w-[298px] h-[64px] items-center rounded-[12px] border-2 border-[#32BDFF] px-[12px] bg-white">
                        <img src="src/assets/elements/email.svg" alt="email" className="ml-3 h-5 w-5 flex-shrink-0" />
                        <input
                            type="email"
