const HowItWorks = () => {
    return (
        <section className="w-full h-220 flex justify-center py-20">
            <div className="w-291.5 h-250 mx-auto flex flex-col gap-8 items-center justify-center">
                <h2 className="font-['Manrope'] font-bold text-5xl leading-13 text-center text-[#3D3D3D]">How <span className="bg-[linear-gradient(98.64deg,#88D8FF_27.32%,#0179B4_69.76%)] bg-clip-text text-transparent font-bold">our platform</span> works</h2>
                <p className="w-191.5 h-12 font-['Manrope'] font-semibold text-base leading-6 text-center text-[#B0B0B0]">Navigating your healthcare journey with HealNet is seamless. Just follow these steps mentioned below to proceed with your selected services. You can also see our FAQ section for more guidance:</p>
